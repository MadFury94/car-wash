<template>
  <div>
    <Switch v-model="enabled" :class="[enabled ? 'bg-secondary-600' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-secondary-600 focus:ring-offset-2']">

    ...
    <div class="relative">
      <div class="grid justify-items-center">
        ...
        <img
          :src="image"
          alt=""
          class="h-[600px]  w-[500px] object-cover inset-0 -z-10 rounded-2xl"
        />
      </div>

      <div class="grid justify-items-center bg-green-500 mb-40">
        <div
          class="border -mt-52 absolute border-black rounded-2xl w-[400px] h-[300px] bg-white p-20"
        >
          <div

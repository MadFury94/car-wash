<template>
  <div class="bg-gray-900">
    <div class="isolate relative overflow-hidden pt-14">
      <div class="absolute inset-0 bg-black opacity-50"></div>
      <img
        src="https://www.sprynxmulti.com/wp-content/uploads/2020/04/car1.jpg"
        alt=""
        class="absolute h-full inset-0 -z-10 w-full object-cover"
      />

      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 relative z-10">
        <div class="text-center">
          <h1 class="heading tracking-tight">Sprynx Multi</h1>
          <p class="mt-6 para">
